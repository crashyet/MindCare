        ...
        <main class="lg:ml-64 min-h-screen pt-16 lg:pt-0">
            <div class="p-4 md:p-8">
                <div class="space-y-8 animate-fade-in">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold mb-2">Selamat Datang di  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae praesentium dolore tempora tempore, nemo quisquam earum iure tenetur sed doloremque pariatur dignissimos neque? Error alias vel magnam? Veniam, voluptate nisi.
                            <span
