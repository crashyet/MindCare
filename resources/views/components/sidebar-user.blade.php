...
<aside
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto mt-16 lg:mt-0">
            <a class="{{ request()->is('dashboard') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium shadow-soft' : 'text-sidebar-foreground hover:bg-sidebar-accent/50' }} flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth"
                href="/dashboard">
            ...
            <a class="{{ request()->is('dashboard/artikel') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium shadow-soft' : 'text-sidebar-foreground hover:bg-sidebar-accent/50' }} flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth"
        ...
        <span>Edukasi</span>
            ...
            <a class="{{ request()->is('dashboard/forum') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium shadow-soft' : 'text-sidebar-foreground hover:bg-sidebar-accent/50' }} flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth"
            ...
            <a class="{{ request()->is('dashboard/tes') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium shadow-soft' : 'text-sidebar-foreground hover:bg-sidebar-accent/50' }} flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth"
                href="/dashboard/tes">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <a class="{{ request()->is('dashboard/chatbot') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium shadow-soft' : 'text-sidebar-foreground hover:bg-sidebar-accent/50' }} flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth"
        ...
        <div class="p-4 border-t border-sidebar-border space-y-3">
            <button
                ...
                type="button" id="radix-:r0:" aria-haspopup="menu" aria-expanded="false" data-state="closed">
                <span
                    class="relative flex items-center justify-center shrink-0 overflow-hidden rounded-full w-10 h-10 bg-primary">
                    <div class="flex items-center justify-center aspect-square h-full w-full text-foregroud">
