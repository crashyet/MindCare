        ...
        <div class="p-4 md:p-8">
            <div class="space-y-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-foreground">Manajemen Edukasi &amp; Quiz</h1>
                        <p class="text-muted-foreground">Kelola konten edukasi dan quiz</p>
                    </div><button
                    ...
                    <div class="flex flex-col space-y-1.5 p-6">
                        <div class="flex items-center gap-4">
                            <div class="relative flex-1"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    placeholder="Cari quiz..." value=""></div>
                        </div>
                    </div>
                    <div class="p-6 pt-0">
                            ...
                            <table class="w-full caption-bottom text-sm">
                                ...
                                <tbody class="[&amp;_tr:last-child]:border-0">
                                    <tr class="border-b transition-colors data-[state=selected]:bg-muted hover:bg-muted/50">
                                        ...
                                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">15 menit</td>
                                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                            <div
                                    ...
                                    <tr
                                        ...
                                        <td
                                            class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0 font-medium max-w-xs truncate">
                                            Quiz Kesehatan Mental Dasar</td>
                                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                            <div
                                                class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80">
                                                General</div>
                                        ...
                                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">20 menit</td>
                                        <td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
                                            <div
                                                class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80">
                                                Published</div>
